    ...
    private void registerPatient() {
        ...
        new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() {
                try {
                    ApiClient.ApiResponse<Void> resp = apiClient.savePatient("create", id, name, contact, address);
            ...
            protected void done() {
                ...
                if (statusCode >= 200 && statusCode < 300) {
                    ...
                    statusLabel.setForeground(Color.RED);
                    statusLabel.setText(errorMessage != null ? errorMessage : "Registration failed (status " + statusCode + ").");
                }
            }
        }.execute();
    }
